...
final readonly class ParsedFlightPlanData
{
     ...
     * @param  array{cost_index?: ?int, ramp?: array{amount: float, unit: string}|null, taxi?: array{amount: float, unit: string}|null, takeoff?: array{amount: float, unit: string}|null, trip?: array{amount: float, unit: string}|null, contingency?: array{amount: float, unit: string}|null, alternate?: array{amount: float, unit: string}|null, final_reserve?: array{amount: float, unit: string}|null, estimated_landing?: array{amount: float, unit: string}|null}  $fuel
