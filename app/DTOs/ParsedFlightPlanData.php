...
final readonly class ParsedFlightPlanData
{
     ...
     * @param  list<array{name: string, role: ?string, base: ?string, employee_number?: ?string, high_mins?: bool}>  $crewMembers
     * @param  array{section_present?: bool, items?: list<array{type: string, number: string, description: string, reference: ?string, status: ?string, limitations: ?string, procedures: ?string}>}  $maintenance
