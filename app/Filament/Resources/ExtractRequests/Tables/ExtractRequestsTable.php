...
namespace App\Filament\Resources\ExtractRequests\Tables;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('parser_type')
                    ...
                    ->sortable()
                    ->searchable(),
                TextColumn::make('extraction_duration_ms')
                    ->label('Duration')
                    ->numeric()
                    ->suffix(' ms')
                    ->sortable()
                ...
                TextColumn::make('app_version')
                    ->searchable()
                    ->toggleable(isToggledHiddenByDefault: true),
                TextColumn::make('extractor_version')
                    ->searchable()
                    ->toggleable(isToggledHiddenByDefault: true),
