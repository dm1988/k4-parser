...
readonly class ExtractResultViewModel
{
    /**
     * @param  list<ExtractEventViewModel|Flight|DutyEvent>  $events
     */
    ...
    public static function fromData(ExtractedResultData $result): self
    {
        ...
        foreach (($result->parsed['calendar_events'] ?? []) as $event) {
            ...
            $eventViewModels[] = ExtractEventViewModel::fromArray($event, $parseKey);
        }
