<form method="POST" action="{{ route('parse.roster') }}" enctype="multipart/form-data" class="cc-card" id="parserForm"
    ...
    <div class="border-b border-[#1B365D]/10 p-5">
        ...
        <div id="parserStatus" class="mt-4 rounded-lg border border-[#1B365D]/10 px-4 py-3" x-bind:class="statusPanelClasses"
            role="status" aria-live="polite" x-bind:data-state="statusState">
            <div class="flex items-start gap-3">
                <span id="parserStatusDot" class="mt-1.5 h-2.5 w-2.5 shrink-0 rounded-full" x-bind:class="statusDotClasses"
                    aria-hidden="true"></span>
                <div class="space-y-1">
