<form method="POST" action="{{ route('parse.roster') }}" enctype="multipart/form-data" class="cc-card" id="parserForm">
    ...
    <div class="border-b border-[#1B365D]/10 p-5">
        <div class="flex flex-col gap-4 md:flex-row md:items-end">
            <div class="flex-1">
                <label for="file" class="mb-2 block text-sm font-semibold text-[#1B365D]">Roster screenshot or trip PDF</label>
                <input
                    id="file"
                    type="file"
                    name="file"
            ...
            <button id="parseBtn" class="rounded-md bg-[#C5A059] px-6 py-3 font-bold text-[#0B0E14] shadow-sm transition hover:bg-[#b6914b]">
    ...
    <details class="border-t border-[#1B365D]/10 p-5">
        ...
        @enderror
        <p class="mt-3">
            <button class="cc-btn-cta">Parse</button>
        </p>
    </details>
    <script>
        ...
        // Show client-side feedback when parsing
