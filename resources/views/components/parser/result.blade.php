...
<aside class="space-y-5">
        ...
        <div class="space-y-4 p-5">
            ...
            <div class="space-y-3">
                ...
                <article class="rounded-md border border-[#1B365D]/10 p-3">
                    ...
                    <div class="mt-3 flex justify-end gap-2 sm:items-center">
    ...
    <details class="rounded-lg border border-[#1B365D]/15 bg-white p-5 shadow-sm">
        ...
        <pre
            class="mt-4 max-h-[28rem] overflow-auto rounded-md bg-[#0B0E14] p-4 text-xs text-[#C5A059]">{{ $model->rawJson }}</pre>
    </details>
</aside>
@endif