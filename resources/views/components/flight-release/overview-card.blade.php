...
<article
    ...
    {{ $attributes->class([
        'group flex min-w-0 flex-col gap-4 rounded-xl border border-[#1B365D]/10 bg-white p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-[#C5A059]/70 hover:shadow-md dark:border-slate-700 dark:bg-slate-900',
    ]) }}
>
