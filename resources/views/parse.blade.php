...
<body class="min-h-screen bg-[#F8F9FA] text-[#0B0E14]">
    ...
    <main class="mx-auto grid max-w-6xl gap-6 px-5 py-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(340px,0.95fr)]">
        <section>
        ...
        <aside class="space-y-5">
            <section class="rounded-lg border border-[#1B365D]/15 bg-white shadow-sm">
                ...
                @else
                    <div class="p-5 text-sm leading-6 text-[#4A5568]">
                        <p class="font-semibold text-[#1B365D]">Ready for upload.</p>
                        <p class="mt-2">Results will appear here after the roster image is parsed.</p>
                    </div>
                @endif
            </section>
