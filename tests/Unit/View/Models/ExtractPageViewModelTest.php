...
class ExtractPageViewModelTest extends TestCase
{
    #[Test]
    public function it_builds_selected_types_without_legacy_old_input(): void
    {
        $viewModel = ExtractPageViewModel::fromResult(ExtractedResultData::fromArray([
            'filters' => ['flight'],
        ]));
    ...
    public function it_hydrates_the_full_result_from_cache_when_session_only_has_a_trimmed_payload(): void
    {
        ...
        $viewModel = ExtractPageViewModel::fromResult(app(EngineResultCache::class)->latest());
    ...
    {
        $viewModel = ExtractPageViewModel::fromResult(null);
