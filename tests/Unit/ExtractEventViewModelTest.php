...
class ExtractEventViewModelTest extends TestCase
{
    ...
    public function test_it_truncates_partial_minutes_when_formatting_duration_labels(): void
    {
        $model = ExtractEventViewModel::fromArray([
            'title' => 'Layover ICN',
            'type' => 'layover',
            'start' => '2026-07-02T23:59:00+00:00',
            'end' => '2026-07-03T00:59:59+00:00',
            'metadata' => [],
            'download_id' => '01JTESTEVENTKEYABC123',
        ], '01JTESTPARSEKEYABC123');

        $this->assertSame('1h 0m', $model->durationLabel);
    }
}
