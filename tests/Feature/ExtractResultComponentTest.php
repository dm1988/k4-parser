...
use App\View\Models\Extract\ExtractResultViewModel;
use Illuminate\Support\Facades\Blade;
use Tests\TestCase;

class ExtractResultComponentTest extends TestCase
{
    public function test_it_renders_the_export_button_in_the_header_without_helper_copy(): void
    {
        $html = Blade::render('<x-extract.result :model="$model" />', [
            'model' => ExtractResultViewModel::fromData(ExtractedResultData::fromArray([
                'source' => 'text',
    ...
    private function makeResultModel(): ExtractResultViewModel
    {
        return ExtractResultViewModel::fromData(ExtractedResultData::fromArray([
            'source' => 'text',
            'parse_key' => '01KXK47PE0HNRXE4VV2N8K8N58',
            'filters' => [],
            'parsed' => [
