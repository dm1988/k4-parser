...
class FlightPlanBriefTest extends TestCase
{
    ...
    public function test_etops_uses_a_dedicated_typed_layout_and_renders_the_source_rating_in_the_header(): void
    {
        ...
        Livewire::actingAs(User::factory()->admin()->create())
            ...
            ->assertSeeText('ETP points')
            ->assertSeeText('ETOPS time')
            ->assertSeeText('180 min')
    ...
    public function test_maintenance_log_renders_source_backed_context_items_limitations_and_crew_without_reparsing(): void
    {
        ...
        $component
            ...
            ->assertSeeHtml('font-mono text-5xl font-black leading-none text-red-700 dark:text-red-300')
